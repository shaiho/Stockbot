...
MIN_ALERT_CHECK_MINUTES = int(os.getenv("MIN_ALERT_CHECK_MINUTES", "1"))
...
MARKET_EVENTS_CHECK_MINUTES = int(os.getenv("MARKET_EVENTS_CHECK_MINUTES", "60"))
HOLIDAY_REFRESH_DAYS = int(os.getenv("HOLIDAY_REFRESH_DAYS", "7"))
